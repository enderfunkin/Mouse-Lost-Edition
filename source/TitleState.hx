	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['VS Mickey Lost Edition by'], 15);
					#else
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('Tima Retro Team', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['Mouse by', 'with'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 7:
					addMoreText('Disney Sheet', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('The Lost Files');
				// credTextShit.visible = true;
				case 14:
					addMoreText('of');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Mickey Cartoon'); // credTextShit.text += '\nFunkin';
